...
module.exports = function (config) {
    const testWebpackConfig = require('../build/webpack.test.js')({ env: 'test' });
    ...
    const configuration = {
      ...
      */
       ...
       *
       * we are building the test environment in ./test_index.js
       */
      files: [
       ...
       */
      preprocessors: { 'test_index.js': ['coverage', 'webpack', 'sourcemap'] },
